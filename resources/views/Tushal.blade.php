...
<!--logo start-->
<div class="brand">
    <a href="{{url('Adminassets')}}/index.html" class="logo">
        VISITORS
    </a>
            ...
            <ul class="dropdown-menu extended notification">
                ...
                <li>
                    <div class="alert alert-info clearfix">
                        ...
                        <div class="noti-info">
                            <a href="{{url('Adminassets')}}/#"> Server #1 overloaded.</a>
                        </div>
                    </div>
                </li>
                <li>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="{{url('Adminassets')}}/#">
                <img alt="" src="{{url('Adminassets')}}/images/2.png">
                <span class="username">John Doe</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="{{url('Adminassets')}}/#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="{{url('Adminassets')}}/#"><i class="fa fa-cog"></i> Settings</a></li>
                <li><a href="{{url('Adminassets')}}/login.html"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{url('Adminassets')}}/index.html">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('Adminassets')}}/typography.html">Typography</a></li>
						<li><a href="{{url('Adminassets')}}/glyphicon.html">glyphicon</a></li>
                        <li><a href="{{url('Adminassets')}}/grids.html">Grids</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{url('Adminassets')}}/fontawesome.html">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('Adminassets')}}/basic_table.html">Basic Table</a></li>
                        <li><a href="{{url('Adminassets')}}/responsive_table.html">Responsive Table</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{url('Adminassets')}}/javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('Adminassets')}}/form_component.html">Form Elements</a></li>
                        <li><a href="{{url('Adminassets')}}/form_validation.html">Form Validation</a></li>
						<li><a href="{{url('Adminassets')}}/dropzone.html">Dropzone</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{url('Adminassets')}}/javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('Adminassets')}}/mail.html">Inbox</a></li>
                        <li><a href="{{url('Adminassets')}}/mail_compose.html">Compose Mail</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{url('Adminassets')}}/javascript:;">
				...
				<!--notification start-->
					...
					<div class="notify-w3ls">
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="{{url('Adminassets')}}/#">Jonathan Smith</a></span> send you a mail </li>
						...
						<div class="alert alert-danger">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="{{url('Adminassets')}}/#">Jonathan Smith</a></span> mentioned you in a post </li>
						...
						<div class="alert alert-success ">
							...
							<div class="notification-info">
								...
								<p>
									<a href="{{url('Adminassets')}}/#">Anjelina Mewlo, Jack Flip</a> and <a href="{{url('Adminassets')}}/#">3 others</a>
								</p>
							</div>
						</div>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 Visitors. All rights reserved | Design by <a href="{{url('Adminassets')}}/http://w3layouts.com">W3layouts</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<script src="{{url('Adminassets')}}/js/bootstrap.js"></script>
<script src="{{url('Adminassets')}}/js/jquery.dcjqaccordion.2.7.js"></script>
<script src="{{url('Adminassets')}}/js/scripts.js"></script>
<script src="{{url('Adminassets')}}/js/jquery.slimscroll.js"></script>
<script src="{{url('Adminassets')}}/js/jquery.nicescroll.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{url('Adminassets')}}/js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="{{url('Adminassets')}}/js/jquery.scrollTo.js"></script>
<!-- morris JavaScript -->	
<script>
...
<!-- calendar -->
	<script type="text/javascript" src="{{url('Adminassets')}}/js/monthly.js"></script>
