...
<section class="w3l-contact-11">
		<div class="container py-lg-5">
			<div class="content-info-in row">
				<div class="col-lg-6">
					<img src="{{url('ClientAssets')}}/images/ab1.jpg" alt="" class="img-fluid">
				</div>
			...
			<div class="container py-lg-4">
				<div class="content-info-in row">
					...
					<div class="content-right col-lg-6">
						<img src="{{url('ClientAssets')}}/images/ab4.jpg" class="img-fluid" alt="">
					</div>
						...
						<div class="content-4-bottom">
							<div class="content4-right-grids mb-md-0 mb-4">
								...
								<div class="content4-right-info">
									<h6><a href="{{url('ClientAssets')}}/#">Our Stories</a></h6>
							...
							<div class="content4-right-grids mb-md-0 mb-4">
								...
								<div class="content4-right-info">
									<h6><a href="{{url('ClientAssets')}}/#">Our Mission</a></h6>
									<p>Lorem ipsum dolor sit amet,facere aperiam.</p>
								</div>
			...
			<div class="row inner-sec-w3layouts-w3pvt-lauinfo">
				<div class="col-md-3 col-6">
					<div class="team-grids text-center">
						<img src="{{url('ClientAssets')}}/images/team1.jpg" class="img-fluid" alt="">
						<div class="team-info">
							<div class="caption">
								<h4>Dan Jones</h4>
								<h6>Technician</h6>
				...
				<div class="col-md-3 col-6">
					<div class="team-grids text-center">
						<img src="{{url('ClientAssets')}}/images/team2.jpg" class="img-fluid" alt="">
						<div class="team-info">
							<div class="caption">
								<h4>Zara Conner</h4>
								<h6>Technician</h6>
				...
				<div class="col-md-3 col-6 mt-md-0 mt-4">
					<div class="team-grids text-center">
						<img src="{{url('ClientAssets')}}/images/team3.jpg" class="img-fluid" alt="">
						<div class="team-info">
							<div class="caption">
								<h4>John Chater</h4>
								<h6>Technician</h6>
					...
					<div class="social-icons-section text-center">
						<a class="fac" href="{{url('ClientAssets')}}/#url">
							<i class="fa fa-facebook"></i>
						</a>
						<a class="twitter" href="{{url('ClientAssets')}}/#url">
							<i class="fa fa-twitter"></i>
						</a>
					</div>
				</div>
				<div class="col-md-3 col-6 mt-md-0 mt-4">
					<div class="team-grids text-center">
						<img src="{{url('ClientAssets')}}/images/team4.jpg" class="img-fluid" alt="">
						<div class="team-info">
							<div class="caption">
								<h4>June Smith</h4>
								<h6>Technician</h6>
