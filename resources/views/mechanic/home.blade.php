...
@section('content')
    ...
    <!-- for amcharts js -->
            <script src="{{url('mechanicassets')}}/js//amcharts.js"></script>
            <script src="{{url('mechanicassets')}}/js//serial.js"></script>
            <script src="{{url('mechanicassets')}}/js//export.min.js"></script>
            <link rel="stylesheet" href="{{url('mechanicassets')}}/css/export.css" type="text/css" media="all" />
            <script src="{{url('mechanicassets')}}/js//light.js"></script>
    <!-- for amcharts js -->

    <script  src="{{url('mechanicassets')}}/js//index1.js"></script>
    ...
    <script src="{{url('mechanicassets')}}/js//Chart.bundle.js"></script>
    <script src="{{url('mechanicassets')}}/js//utils.js"></script>
    ...
    <!-- Classie --><!-- for toggle left push menu script -->
        <script src="{{url('mechanicassets')}}/js//classie.js"></script>
        <script>
    ...
    <!--scrolling js-->
    <script src="{{url('mechanicassets')}}/js//jquery.nicescroll.js"></script>
    <script src="{{url('mechanicassets')}}/js//scripts.js"></script>
    <!--//scrolling js-->
    ...
    <script src="{{url('mechanicassets')}}/js//SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
   ...
   <script src="{{url('mechanicassets')}}/js//bootstrap.js"> </script>
    <!-- //Bootstrap Core JavaScript -->
