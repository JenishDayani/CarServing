...
<div class="forms">
	...
	<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
		...
		<div class="form-body">
			<form method="post" action="{{route('manageprofile')}}" enctype="multipart/form-data">
				@csrf
				@method('POST')
				<div class="form-group">
					<label for="exampleInputEmail1">Name</label> 
					<input type="text" class="form-control" name="mechanic_name" id="exampleInputEmail1" value="{{$b->name}}">
				</div>
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="experience" value="{{$mechanic->experience}}" 
					id="exampleInputEmail1" placeholder="Your Experience">
					@error('experience')
				...
				<label class="form-group" >Choose a city</label>
					<select name="city" id="city">
						@foreach($city as $c)
						<option value="{{$c->cityname}}"<?php if($c->cityname == $b->city){ echo 'selected'; } ?>>{{$c->cityname}}</option>
						@endforeach
					</select>
					<br><br>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="contact_number" value="{{$mechanic->con_number}}" 
					placeholder="Enter Your Contact Number" id="exampleInputEmail1">
					@error('contact_number')
					<div class="alert alert-danger">{{ $message }}</div>
					@enderror
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Mechanic Fees</label> 
					<input type="number" class="form-control" name="mechanic_fees" id="exampleInputEmail1" 
					value="{{$mechanic->mechanic_fees}}">
				</div>


				<div class="form-group"> 
					<label for="exampleInputFile">Add Photo</label> 
					<input type="file" id="exampleInputFile" name="mechanic_image"> 
				</div>
